...
class User(Entity):
    ...
    user_documents = db.relationship('UserDocument', backref='user')
 #+END_SRC
...
**** Constructor
#+BEGIN_EXAMPLE 
    user_document = Userfile(name=str, path=str,  user=<instance of class User>)
...
**** Tests for User Document Constructor
#+BEGIN_SRC python :tangle tests/test_db.py :eval no 
...
#+END_SRC
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_user_document_constructor(self):
        print "test_user_document_constructor"
        ...
        user_document = UserDocument(name="Student Photo", user=user)
        user_document.save()
        
        # Calling the user_document constructor without any arguments should
        # raise AttributeRequired exception
        self.assertRaises(AttributeRequired, UserDocument)

        # Calling the user_document constructor with necessary arguments
        # (user,path) but with wrong type should raise TypeError
        self.assertRaises(TypeError, UserDocument,
                          ,**{'path': 12,
                              'name':"College Report",
                              'user': user
                            })
...
#+END_SRC
**** Functions that operate on the User Document domain
***** getAll: Nil --> set[UserDocument]
#+BEGIN_SRC python :tangle src/db.py :eval no
    @staticmethod
    def get_all():
...
***** Test getAll: Nil --> set[UserDocument]
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_user_documents_get_all(self):
        print "test_user_documents_get_all"
        ...
        student_report1 = UserDocument(name="College Report", path="/static/uploads/college-files/file.pdf",
                             user=user)
        user_document1.save()

        user_document2 = UserDocument(name="User Photos", path="/static/uploads/college-files/photos.png",
                             user=user)
        user_document2.save()

        user_document_list = UserDocument.get_all()
        
        self.assertEqual("College Report", user_document_list[0].name)
        self.assertEqual("User Photos", user_document_list[1].name)

        self.assertEqual("/static/uploads/college-files/file.pdf", user_document_list[0].path)
        self.assertEqual("/static/uploads/college-files/photos.png", user_document_list[1].path)

#+END_SRC

***** getUserDocument: Id --> UserDocument
#+BEGIN_SRC python :tangle src/db.py :eval no 
    @staticmethod
    def get_by_id(id):
        return UserDocument.query.get(id)

#+END_SRC

***** Test getUserDocument: Id --> UserDocument
#+BEGIN_SRC python :tangle tests/test_db.py :eval no 
    def test_get_user_document_by_id(self):
        ...
        user_document = UserDocument(name="College Report", path="/static/uploads/college-files/file.pdf", user=user)
        user_document.save()

        self.assertEqual(user_document.get_by_id(1).path, "/static/uploads/college-files/file.pdf" )
        self.assertEqual(user_document.get_by_id(1).name, "College Report" )

#+END_SRC
     
***** getPath: UserDocument --> String
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_path(self):
        return self.path
#+END_SRC

***** Test getPath: UserDocument --> String
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_get_user_document_path(self):
        print "test_get_user_document_path"
        name = Name("Student")
        role = Role(name=name)
        role.save()
        ...
        user_document_path = user_document.get_path()
        self.assertEqual(user_document_path, "/static/uploads/college-files/file.pdf")

#+END_SRC
     
***** getName: UserDocument --> String
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_name(self):
        return self.name
#+END_SRC

***** Test getName: UserDocument --> String
#+BEGIN_SRC python :tangle tests/test_db.py :eval no 
    def test_get_user_document_name(self):
        print "test_get_user_document_name"
        ...
        user_document_name = user_document.get_name()
        self.assertEqual(user_document_name, "College Report")

#+END_SRC
     
***** getUser: UserDocument --> User
#+BEGIN_SRC python :tangle src/db.py :eval no 
    def get_user(self):
        return self.user
#+END_SRC
...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no 
    def test_get_user_document_user(self):
        print "test_get_user_document_user"
        ...
        user = user_document.get_user()
        self.assertEqual("Coordinators Training", user.name )

#+END_SRC
***** setPath: UserDocument, String --> Void
#+BEGIN_SRC python :tangle src/db.py :eval no 
    @typecheck(path=str)
...
***** Test setPath: UserDocument, String --> Void
#+BEGIN_SRC python :tangle tests/test_db.py :eval no 
    def test_set_user_document_path(self):
        print "test_set_user_document_path"
        ...
        user_document.set_path("/static/uploads/college-files/file.doc")
        user_document.save()

        doc = user_document.get_by_id(1)
        self.assertEqual(doc.path, "/static/uploads/college-files/file.doc")
#+END_SRC
      
***** setName: UserDocument, String --> Void
#+BEGIN_SRC python :tangle src/db.py :eval no 
    @typecheck(name=str)
    def set_name(self, name):
        self.name = name
...
***** Test setName: UserDocument, String --> Void
#+BEGIN_SRC python :tangle tests/test_db.py :eval no 
    def test_set_user_document_name(self):
        print "test_set_user_document_name"
        name = Name("Student")
        role = Role(name=name)
        role.save()
        ...
        user_document.set_name("User Photos")
        user_document.save()
...
***** setUser: UserDocument, User --> Void
#+BEGIN_SRC python :tangle src/db.py :eval no
    @typecheck(user=User)
...
***** Test setUser: UserDocument, User --> Void
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_set_user_document_user(self):
        print "test_set_user_document_user"
        role = Role(name=Name("Student"))
        ...
        user_document = UserDocument(name= "College Report", path="/static/uploads/college-files/file.pdf", user=user1)
        user_document.save()
     
        user_document.set_user(user2)
        user_document.save()
        self.assertEqual(user_document.user.name, "madhavi")
#+END_SRC
***** to_client
#+BEGIN_SRC python :tangle src/db.py :eval no 
    def to_client(self):
...
***** Test UserDocument to_client
#+BEGIN_SRC python :tangle tests/test_db.py :eval no 
    def test_user_document_to_client(self):
        print "test_user_document_to_client"
        ...
        self.assertEqual("/static/uploads/college-files/file.pdf", doc_dict['path'])
        self.assertEqual("College Files", doc_dict['name'])
...
user_document = {'entity_class': UserDocument,
                  'attributes': [
                      {'name': 'id',
                       'class': None,
                       'relationship': 'one'},
...
@api.route('/upload_user_documents/<id>', methods=['GET', 'POST'])
def save_user_documents(id):
    ...
    if request.method == 'POST':
        ...
        if response.ok:
            ...
            return "No entry for 'User Documents' entity with given id"
...
class TestUserDocument(TestCase):
    ...
    def test_get_all_user_documents(self):
        print "test_get_all_user_documents"
        ...
        user_document1 = UserDocument(name="College Report",
                                          path="/static/uploads/college-files/file.pdf",
                                          user=user_1)
        user_document1.save()

        user_document2 = UserDocument(name="College Report",
                                          path="/static/uploads/college-files/file.pdf",
                                          user=user_2)
        user_document2.save()


        r = self.client.get('/user_documents')
        result = json.loads(r.data)
        self.assertEquals(len(result), 2)

    def test_get_one_user_document(self):
        print "test_get_one_user_document"
        ...
        r = self.client.get('/user_documents/1')
        result = json.loads(r.data)
        print result
        self.assertEqual(result['name'], "College Report")

    def test_update_existing_user_document(self):
        print "test_update_existing_user_document"
        ...
        r = self.client.put('/user_documents/1',
    ...
    def test_create_new_user_document(self):
        print "test_create_new_user_document"
        ...
        r = self.client.post('/user_documents',
                             data=json.dumps({ 'name' : 'College Report',
                                               'path' : '/static/uploads/college-files/file.pdf', 
                                               'user': user.to_client()
                                           }))
        result = json.loads(r.data)
        self.assertEqual(result['name'], "College File")

    def test_delete_user_document(self):
        print "test_delete_user_document"
        ...
        user_document1 = UserDocument(name="College File",
                                          path="/static/uploads/college-files/file.pdf",
                                          user=user_1)
        user_document1.save()

        user_document2 = UserDocument(name="User Photos",
                                          path="/static/uploads/user-photos/photo.png",
                                          user=user_2)
        user_document2.save()
        
        r = self.client.delete('/user_documents/1')
        r = self.client.get('/user_documents')
        result = json.loads(r.data)
        self.assertEqual(len(result), 1)
